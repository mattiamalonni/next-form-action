...
export const createFormActionState = (
...
export const createFormAction = (
  ...
  return async (state: FormActionState, formData: FormData): Promise<FormActionState> => {
    try {
      const error = (message: FormActionState['message'], params: FormActionParams = {}) =>
        throwFormActionError(formData, message, params);

      const success = (message: FormActionState['message'], params: FormActionParams = {}) =>
